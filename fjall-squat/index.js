...
// This is a name-squat placeholder for the unscoped `fjall` npm package.
...
var msg =
  'The `fjall` npm package is a placeholder and does NOT contain the TypeScript wrapper for fjall. ' +
  'Install the real package instead:\n\n' +
  '    npm install @fjall-js/fjall\n\n' +
  'See https://github.com/tomusdrw/fjall-js for details.';

console.error('[fjall] ' + msg);
